...
class _MainProfileSettingsScreenState extends State<MainProfileSettingsScreen> {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              _buildStats(context),
              if (kIsWeb) _buildCameraTip(context),
              _buildMenu(context),
            ],
          ),
        ),
  ...
  Widget _buildCameraTip(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Por defecto iOS bloquea el acceso a la cámara en el navegador. '
              'Para poder tomar fotos de los arreglos directamente desde la app:',
              style: TextStyle(
                fontSize: 13,
            ...
            const SizedBox(height: 8),
            const Text(
              'Si no tienes acceso a la cámara, también puedes subir fotos desde tu Fototeca.',
              style: TextStyle(
                fontSize: 12,
                color: Color(0xFF92400E),
